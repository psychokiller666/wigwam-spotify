<template>
  <div class="container">
    <article class="mw5 center br3 pa3 pa4-ns mv3 ba b--black-10">
      <button @click="login()" class="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2 bg-dark-green" title="Spotify">
